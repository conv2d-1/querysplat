...
from hAlgorithm.modules.models2.external.worldmirror.models.models.visual_transformer import VisualGeometryTransformer
from hAlgorithm.modules.models2.external.worldmirror.models.heads.camera_head import CameraHead
from hAlgorithm.modules.models2.external.worldmirror.models.heads.dense_head import DPTHead
from hAlgorithm.modules.models2.external.worldmirror.models.models.rasterization import GaussianSplatRenderer
from hAlgorithm.modules.models2.external.worldmirror.models.utils.camera_utils import vector_to_camera_matrices, extrinsics_to_vector
from hAlgorithm.modules.models2.external.worldmirror.models.utils.priors import normalize_depth, normalize_poses
    ...
    def _gen_all_preds(self, token_list, context_token_list, 
        ...
        if self.enable_gs:
            ...
            gs_feat, gs_depth, gs_depth_conf = self.gs_head(
                context_token_list, images=imgs[:,:views["context_nums"]].float(), patch_start_idx=patch_start_idx
            )
