...
from hAlgorithm.modules.models2.external.depth_anything_3.utils.export.gs import export_to_gs_ply, export_to_gs_video
...
from .points import  export_to_points
...
def export(
    ...
    **kwargs,
    ...
    if export_format == "points":
        export_to_points(prediction, export_dir, **kwargs.get(export_format, {}))
