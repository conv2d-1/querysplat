...
from hAlgorithm.modules.models2.external.romav2.models.romav2.local_correlation import local_correlation
...
from hAlgorithm.modules.models2.external.romav2.models.romav2.geometry import bhwc_grid_sample
from hAlgorithm.modules.models2.external.romav2.models.romav2.types import RefinersType, NormType
...
class ConvRefiner(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        if delta_confidence.shape[-1] == 4 and self.cfg.confidence_type == "roma":
            chol_eps = 1e-6
...
class Refiners:
    ...
    def __new__(cls, cfg: Cfg):
        ...
        refiner_configs = {k: refiner_configs[k] for k in cfg.refine_scales}
