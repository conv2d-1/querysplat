...
from hAlgorithm.modules.models2.external.romav2.models.romav2.types import ConfidenceMode
import numpy as np
...
def bhwc_grid_sample(
    ...
    return F.grid_sample(
        x.permute(0, 3, 1, 2).float(), grid.float(), mode=mode, align_corners=align_corners
    ).permute(0, 2, 3, 1)
