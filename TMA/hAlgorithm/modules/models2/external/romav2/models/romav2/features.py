...
from hAlgorithm.modules.models2.external.romav2.models.romav2.normalizers import imagenet
from hAlgorithm.modules.models2.external.romav2.models.romav2.types import Normalizer, DescriptorName
...
class Descriptor:
    ...
    class Cfg:
        ...
        repo_or_dir: str ="hAlgorithm/modules/models2/external/romav2/models/dinov3"
        weights_path: str | None = "/mnt/netdata/Team/AI/personal/wsz/checkpoints/DINOv3/dinov3_vitl16_pretrain_lvd1689m-8aa4cbdd.pth"
        ...
        match cfg.name:
            case "dinov3_vitl16":
                ...
                dinov3_vitl16: nn.Module = torch.hub.load(
                    repo_or_dir=cfg.repo_or_dir,
                    source="local" if os.path.exists(cfg.repo_or_dir) else "github",
                    model="dinov3_vitl16",
