...
from hAlgorithm.modules.models2.external.vggt_omega.models.layers import SelfAttentionBlock


class CameraHead(nn.Module):
    """Camera head used by the released VGGT-Omega checkpoints."""

    def __init__(self, dim_in: int = 2048, pretrain=None, pertrain_strict=True, use_checkpoint=False) -> None:
        super().__init__()
        ...
        if pretrain is not None:
            ...
            logging.info(f"CameraHead, load pretrain {pretrain}")
