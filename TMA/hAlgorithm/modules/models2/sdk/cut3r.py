...
from hAlgorithm.modules.models2.external.cut3r.croco.models.croco import CroCoNet, CrocoConfig
...
from hAlgorithm.modules.models2.external.cut3r.dust3r.utils.camera import PoseEncoder
from hAlgorithm.modules.models2.external.cut3r.dust3r.patch_embed import get_patch_embed
from hAlgorithm.modules.models2.external.cut3r.dust3r.utils.misc import (
    fill_default_args,
    freeze_all_params,
    is_symmetrized,
    interleave,
            ...
            try:
                ...
                for key in new_ckpt:
                    if key in self.state_dict():
                        ...
                        logging.info(f"Skipping '{key}': not found in model")
                return super().load_state_dict(new_new_ckpt, **kw)
