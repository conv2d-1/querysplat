...
# from hAlgorithm.modules.models2.external.depth_anything_3.cfg import create_object
from hAlgorithm.modules.models2.external.depth_anything_3.model.utils.transform import pose_encoding_to_extri_intri
from hAlgorithm.modules.models2.external.depth_anything_3.utils.alignment import (
...
from hAlgorithm.modules.models2.external.depth_anything_3.utils.geometry import affine_inverse, as_homogeneous, map_pdf_to_opacity
...
def create_object(cfg_obj):
    return instantiate_from_config(cfg_obj)
...
class DepthAnything3Net(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        """
        if "w2c" in kwargs and extrinsics is None:
            extrinsics = kwargs["w2c"]
