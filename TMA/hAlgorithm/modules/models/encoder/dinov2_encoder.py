...
class Dinov2Encoder(nn.Module):
    ...
    def build_dino(self):
        model_name = (
            ...
            if not self.with_register
            else "dinov2_{:}14_reg".format(self.name)
        )
    ...
    def forward(self, x, meta_data=None, **kwargs):
        ...
        # features = self.dinov2(x, self.model_configs["layer_idxs"], return_class_token=self.use_clstoken)
