...
class MoGeModel(nn.Module):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, Path, IO[bytes]], load_checkpoint=True, model_kwargs: Optional[Dict[str, Any]] = None, ignore_key=None, **hf_kwargs) -> 'MoGeModel':
        """
    ...
    def forward(self, image: torch.Tensor, num_tokens: int, return_features=False) -> Dict[str, torch.Tensor]:
