...
class PromptDinov2Decoder(nn.Module):
    def __init__(
        self,
        features,
        prompt_inchannel,
        ...
        **kwargs,
        ...
        self.use_prompt_dim = use_prompt_dim
        if self.use_prompt_dim is not None:
            self.prompt_inchannel = len(self.use_prompt_dim)
        else:
        ...
        if self.prompt_inchannel < 1:
            self.prompt_flag = [False, False, False, False]
        else:
    ...
    def forward(self, rgb_features, prompt_features=None, meta_data=None, return_rns=False):
        """
        ...
        if prompt_features is not None and self.use_prompt_dim is not None:
            prompt_features = prompt_features[:, self.use_prompt_dim, ...]
        ...
        if return_rns:
            return path_1, (layer_1_rn, layer_2_rn, layer_3_rn, layer_4_rn)

        return path_1

    def get_fused_path(self, layer_rns, prompt_features=None):
        layer_1_rn, layer_2_rn, layer_3_rn, layer_4_rn = layer_rns
