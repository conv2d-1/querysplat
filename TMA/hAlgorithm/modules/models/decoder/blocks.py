...
def _make_fusion_block(
    ...
    return FeatureFusionDepthBlock(
        ...
        apply_zero_module=apply_zero_module,
    )
...
def zero_module(module, apply=True):
    """
...
class FeatureFusionDepthBlock(nn.Module):
    ...
    def __init__(
        ...
        self.align_corners = align_corners
        self.mode = mode
        assert self.mode in ["cat", "add", "cat_add", "mul"]
    ...
    def forward(self, *xs, prompt_depth=None, size=None):
        ...
        if prompt_depth is not None:
            ...
            if self.mode == "add":
                ...
                output = self.skip_add.mul(output, res)
