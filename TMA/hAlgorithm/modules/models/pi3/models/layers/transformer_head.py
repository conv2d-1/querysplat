...
class LinearPts3d (nn.Module):
    ...
    def __init__(self, patch_size, dec_embed_dim, output_dim=3, permute=True, mlp_ratio=None):
        super().__init__()
        ...
        if self.mlp_ratio is not None:
            mlp_hidden_dim = int(dec_embed_dim * mlp_ratio)
            self.mlp = Mlp(
                in_features=dec_embed_dim,
