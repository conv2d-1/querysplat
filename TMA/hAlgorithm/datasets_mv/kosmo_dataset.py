...
from hAlgorithm.datasets.kosmo_dataset import BaseDataset
        ...
        if version == "1.0":
            ...
            for scene, info in data.items():
                ...
                for frame in frames:
                    ...
                    if cam2world_pose is not None and self.extrinsics_name is not None:
...
if __name__ == "__main__":
    ...
    dataset = BaseDatasetMV(
        ...
        data_path="/mnt/nasTeam/Kosmo/json/mid360_insta360/20250924.json",
        track_points_nums=0,
        track_neg_ratio=0.0,
