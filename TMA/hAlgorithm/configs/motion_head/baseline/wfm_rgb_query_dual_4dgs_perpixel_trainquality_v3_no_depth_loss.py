"""V3 ablation: disable target rendered depth + floater losses."""
...
model["sparse_dynamic_gaussian_render_loss"]["target_depth_weight"] = 0.0
model["sparse_dynamic_gaussian_render_loss"]["floater_weight"] = 0.0

output_dir = (
    "/mnt/home/tcchen/workspace/TMA-origin-dev/results/sparse_pair_4dgs_v2/"
    "wfm_rgb_query_dual_4dgs_perpixel_trainquality_v3_no_depth_loss"
)
