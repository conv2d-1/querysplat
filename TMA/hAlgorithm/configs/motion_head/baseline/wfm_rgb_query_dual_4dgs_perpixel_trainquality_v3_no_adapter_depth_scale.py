"""V3 ablation: disable depth-conditioned Gaussian scale in the adapter."""
...
model["model"]["gaussian_adapter"] = copy.deepcopy(model["model"]["gaussian_adapter"])
model["model"]["gaussian_adapter"]["depth_condition_scale"] = False

output_dir = (
    "/mnt/home/tcchen/workspace/TMA-origin-dev/results/sparse_pair_4dgs_v2/"
    "wfm_rgb_query_dual_4dgs_perpixel_trainquality_v3_no_adapter_depth_scale"
)
