...
model = dict(
    ...
    model=dict(
        ...
        motion_head=dict(
            type="hAlgorithm.modules.models2.head.motion_head_4rc.MotionHead4RC",
            dim_in=2 * 1536,
            cross_attn_dim=1536,
            ...
            down_ratio=1,
            pos_embed=True,
            prediction_type="scene_flow",
            random_src_frame=True,
            pretrain=None,
            cross_before_self=True,
            separate_qkv_proj=True,
...
trainer = dict(
    ...
    optimizer={
        ...
        "model.motion_head": dict(lr=5e-5, betas=(0.9, 0.999), weight_decay=1e-3, eps=1e-10),
        "strict_match": True,
        "debug": False,
    },
    eval_metrics=dict(
