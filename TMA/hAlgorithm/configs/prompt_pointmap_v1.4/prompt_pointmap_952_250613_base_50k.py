...
data = dict(
    train="hAlgorithm/configs/prompt_pointmap_v1.4/dataset_configs/base_train_60valid_loss.yaml",
    val="hAlgorithm/configs/prompt_pointmap_v1.4/dataset_configs/base_test_woutdoor.yaml",
    vis="hAlgorithm/configs/prompt_pointmap_v1.4/dataset_configs/total_vis_v2.yaml",
    basic=dict(
    ...
    train_basic=dict(
        ...
        train_transforms=[
            dict(
                type="hAlgorithm.datasets.transforms.transforms.KeepRatioRandomCrop",
                max_size=max_size,
                patch_size=patch_size, 
                crop_type="center",
                prob=1.0,
