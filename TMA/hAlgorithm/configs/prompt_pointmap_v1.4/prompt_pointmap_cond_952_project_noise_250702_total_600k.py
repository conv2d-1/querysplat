...
data = dict(
    train="hAlgorithm/configs/prompt_pointmap_v1.4/dataset_configs/total_train_range_indoor1_outdoor0.5_close1.yaml",
...
model = dict(
    ...
    model=dict(
        type="hAlgorithm.modules.models.combined_model.prompt_mde.ConditionedMDECombinedModel",
        # freeze_modules=["mde_model"],
        rgb_encoder=dict(
            type="hAlgorithm.modules.models.encoder.prompt_conditioned_dinov2_encoder.PromptConditionedDinov2Encoder",
            patch_size=patch_size,
            name="vitb",
            use_clstoken=False,
            ...
            encoder_cond_dim=128,
        ),
        prompt_encoder=dict(
            type="hAlgorithm.modules.models.encoder.mde_prompt_encoder.MdePromptEncoder",
