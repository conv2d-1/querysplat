...
model=dict(
    ...
    model=dict(
        ...
        fuse_encoder=dict(
            ...
            pretrain='SDK/mvfr2.0/stage4/mvfr_da3l_rgb_all8stdy_251120_mvpdc_bs16_2f16f_100k_20251120-230915/checkpoint/latest/fuse_encoder.pth',
...
trainer=dict(
    ...
    load_from="/mnt/netdata/Team/AI/personal/wsz/project/hDepth/total_datas/2602/matching/mvfr_match/total_exp_0226/mvfr_da3l_260112_match_bs4_2f_all0224_with_precision_multires_100k_20260227-123112/checkpoint/latest/ckpt.pth",
    # mem=[10, 1024, 1024, 64],
)
