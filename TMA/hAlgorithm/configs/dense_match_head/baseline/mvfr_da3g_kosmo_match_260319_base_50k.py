...
data=dict(
    train="hAlgorithm/configs/mv_v1.0/dataset_configs_matching_pair/overlap/train_all_overlap_5_260224.yaml",
    val="hAlgorithm/configs/mv_v1.0/dataset_configs_matching_pair/overlap/test_260214.yaml",
    vis="hAlgorithm/configs/mv_v1.0/dataset_configs_matching_pair/vis_260104.yaml",
    basic=dict(
        sem_name='',
...
model=dict(
    ...
    model=dict(
        ...
        fuse_encoder=dict(
            ...
            use_checkpoint_end=12,
            pretrain='/mnt/netdata/Team/AI/SDK/mvfr2.0/stage4/mvfr_da3g_rgb_all8stdy_251120_mvpdc_bs16_2f16f_100k_20251124-114829/checkpoint/latest/fuse_encoder.pth',
