pipeline = dict(
    type="hAlgorithm.datasets.hypersim_dataset.HypersimDataset",
    phase="train",
    name="hypersim",
    seed=0,
    data_root="/mnt/netdata/Team/AI/datasets/TMD/",
    # data_path="/mnt/personal/ts/data/Marigold/data_split/hypersim/train.json",
    data_path="/mnt/personal/ts/data/Marigold/data_split/hypersim/val80.json",
    # data_path="/mnt/personal/ts/data/Marigold/data_split/hypersim/vis.json"
