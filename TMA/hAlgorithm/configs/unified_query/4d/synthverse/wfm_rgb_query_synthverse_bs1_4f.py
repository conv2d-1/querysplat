"""SynthVerse-only 4D tracking training config (PointOdysseyTrackDataset).

Dataset YAML:
  train: hAlgorithm/configs/unified_query/dataset_configs/4d/train_synthverse.yaml
  val:   hAlgorithm/configs/unified_query/dataset_configs/4d/val_synthverse.yaml
  vis:   hAlgorithm/configs/unified_query/dataset_configs/4d/vis_synthverse.yaml

Example:
  cd TMA-origin-dev
  python hAlgorithm/script/train/train_simple.py \\
    --config hAlgorithm/configs/unified_query/4d/synthverse/wfm_rgb_query_synthverse_bs1_4f.py \\
    --exp synthverse_bs1_4f
"""
...
select_dataset = "synthverse"
select_val_dataset = "synthverse_subset50"
select_vis_dataset = "synthverse_subset50"
...
model = dict(
    ...
    local_depth_normal_loss=dict(
        ...
        valid_range=0.95,
        loss_weight=dict(default=0.0, synthverse=0.0),
    ),
