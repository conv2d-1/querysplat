...
data = dict(
    train="hAlgorithm/configs/unified_query/dataset_configs/4d/with_hasim_0423.yaml",
    val="hAlgorithm/configs/unified_query/dataset_configs/4d/with_hasim_val_0423.yaml",
    vis="hAlgorithm/configs/unified_query/dataset_configs/4d/with_hasim_val_0423.yaml",
    basic=dict(
        sem_name="",
...
trainer = dict(
            ...
            dict(
                ...
                eval_groups=[
                    dict(
                        ...
                        # apd_thresholds_3d=[0.05, 0.1, 0.2],
                        apd_thresholds_3d=[],
    ...
    load_from="Autoresearch/Algorithm/Pretrain/MVS/mv_query_260413_baseline/mv_rgb_query_lgc_260413_bs1_4f_50k_20260414-151231/checkpoint/latest/ckpt.pth",
)
