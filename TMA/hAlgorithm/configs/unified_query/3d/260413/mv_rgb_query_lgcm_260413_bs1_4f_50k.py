...
model = dict(
    ...
    model=dict(
        ...
        camera_head=dict(
            ...
            quat_act="linear",
            fl_act="relu",
            # pretrain="/mnt/nasTeam/AI/Autoresearch/Algorithm/Pretrain/MVS/da3_all/mvfr_da3g_rgb_all8stdy_251120_mvpdc_bs16_2f16f_100k_20251124-114829/checkpoint/latest/camera_head.pth",
        ),
