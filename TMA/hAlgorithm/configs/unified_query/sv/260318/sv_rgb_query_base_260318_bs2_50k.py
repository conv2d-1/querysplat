...
select_dataset = ""
# select_dataset += "hypersim,scpp,megasynth,ase,infinigen," # 静态，室内，场景
select_dataset += "hypersim,scpp,infinigen," # 静态，室内，场景
select_dataset += "infinigen_objs,hablendeder_iphone_objs," # 静态，室内，目标
select_dataset += "mvssynth,unreal4k," # 静态，室外，场景
select_dataset += "kubric4d,pointodyssey,dynamicstereo,tartanair,sintel," # 动态
select_dataset += "kenburns,vkitti,staticthings3d,synthia,matrixcity,urbansyn,eden," # 单帧
...
data = dict(
    train="hAlgorithm/configs/unified_query/dataset_configs/sv/train_260301_sv_base.yaml",
    val="hAlgorithm/configs/unified_query/dataset_configs/sv/test_260301_sv.yaml",
    vis="hAlgorithm/configs/unified_query/dataset_configs/sv/vis_260301_sv.yaml",
    basic=dict(
...
model = dict(
    ...
    scale_align=True,
    model=dict(
        type="hAlgorithm.modules.models2.sdk.query.MVQuery2",
        timing=False,
        decoder_fp32=False,
        ...
        query_feats_aggregator=dict(
            type="hAlgorithm.modules.models2.query_aggregator.infinidepth.Aggregator23",
            patch_size=patch_size, 
