data = dict(
    train="hAlgorithm/configs/prompt_pointmap_v1.0/stage1_dataset_configs/total_train_wointerp.yaml",
    val="hAlgorithm/configs/prompt_pointmap_v1.0/stage1_dataset_configs/base_test_wointerp.yaml",
    vis="hAlgorithm/configs/prompt_pointmap_v1.0/stage1_dataset_configs/total_vis_wointerp.yaml",
)
...
model = dict(
    ...
    depth_loss=dict(
        type="hAlgorithm.modules.losses.gradient_loss.GradientLoss",
        msge_weight=0,
        mage_weight=0,
