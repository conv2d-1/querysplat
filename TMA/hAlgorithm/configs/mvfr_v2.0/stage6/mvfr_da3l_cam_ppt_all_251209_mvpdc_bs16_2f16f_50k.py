...
select_vis_dataset = "hypersim,scpp,hablendeder_objs,patagonia,kosmo_0,kosmo_1"
...
model = dict(
    ...
    model=dict(
        ...
        fuse_encoder=dict(
            ...
            add_aux_camera_token=True,
            add_aux_camera_token_every=True,
...
trainer = dict(
    ...
    resume="results/da3_ppt_all_251209/mvfr_da3l_cam_ppt_all_251209_mvpdc_bs16_2f16f_50k_20251209-192324/checkpoint/best/ckpt.pth",
    # load_from="results/da3_ppt_251205/mvfr_da3l_cam_ppt_d4_251205_mvpdc_bs1_4f_50k_gradl1_noise_20251205-190703/checkpoint/latest/ckpt.pth",
