...
trainer = dict(
    ...
    optimizer={
        ...
        "model.fuse_encoder": dict(lr=1e-6, betas=(0.9, 0.999), weight_decay=1e-3, eps=1e-10),
    ...
    # load_from="results/da3_rgb_all_251117/mvfr_da3l_rgb_all8stdy_251117_mvpdc_bs4_4f_100k_20251117-233451/checkpoint/latest/ckpt.pth",
