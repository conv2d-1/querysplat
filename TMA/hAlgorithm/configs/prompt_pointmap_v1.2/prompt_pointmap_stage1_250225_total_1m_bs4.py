data = dict(
    train="hAlgorithm/configs/prompt_pointmap_v1.2/stage1_dataset_configs/total_train_range_hyp_60valid_addmf.yaml",
...
trainer = dict(
    ...
    lr_scheduler=dict(
        ...
        warmup="linear",
        warmup_ratio=1e-6,
        steps=[i for i in range(100000, max_iter, 100000)],
        ratio=0.2,
    ),
    optimizer=dict(
        type="AdamW",
