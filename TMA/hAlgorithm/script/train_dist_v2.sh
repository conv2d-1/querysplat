...
# Usage:
#   bash hAlgorithm/script/train_dist_v2.sh [CONFIG] [LOADFROM] [NNODES] [NUMPROCESSES] [RANK] [MASTER_ADDR] [MASTER_PORT]
#
# Example (trainquality v2 — RGB color anchor, from trainquality ckpt):
#   bash hAlgorithm/script/train_dist_v2.sh
#
# Example (override load_from):
#   bash hAlgorithm/script/train_dist_v2.sh \
#     hAlgorithm/configs/motion_head/baseline/wfm_rgb_query_dual_4dgs_perpixel_trainquality_v2.py \
#     None 1 8
#
...
# gsplat CUDA JIT: default gcc-13 fails on floatn.h; use gcc-11 + A100 (sm_80).
...
DEFAULT_CONFIG="/mnt/home/tcchen/workspace/TMA-origin-dev/hAlgorithm/configs/motion_head/baseline/wfm_rgb_query_dual_4dgs_perpixel_trainquality_v2.py"
