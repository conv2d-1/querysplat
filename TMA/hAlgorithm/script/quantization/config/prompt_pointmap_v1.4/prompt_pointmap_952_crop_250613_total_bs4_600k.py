...
data=dict(
    ...
    quant='hAlgorithm/script/quantization/config/prompt_pointmap_v1.4/quant_config/quant.yaml',
    quant_val='hAlgorithm/script/quantization/config/prompt_pointmap_v1.4/quant_config/quant_val.yaml',
    basic=dict(
    ...
    train_basic=dict(
        ...
        train_transforms=[
            dict(type='hAlgorithm.datasets.transforms.transforms.KeepRatioRandomCrop',
                max_size=952,
                patch_size=14,
                crop_type='center',
                prob=1.0),
    ...
    eval_metrics=dict(
        ...
        metrics=[
            dict(type='hAlgorithm.modules.metrics.depthmap_eval_metrics.DepthEvalMetrics',
                ...
                gt_min_depth=0.001,
                gt_max_depth=200.0,
                metrics=['abs_relative_difference', 'abs_difference', 'rmse_linear', 'delta1_acc', 'delta2_acc']),
            ...
            dict(type='hAlgorithm.modules.metrics.depthmap_eval_metrics.DepthEvalMetrics',
                ...
                gt_min_depth=0.001,
                gt_max_depth=200.0,
                metrics=['abs_relative_difference', 'abs_difference', 'rmse_linear'],
                conf_thresh=0)]
    ),
...
quantization=dict(
    ...
    non_quant_part=[
        '/rgb_encoder/dinov2/patch_embed', 
        '/prompt_encoder/convs.0/', 
        '/head/output_conv2.0/', 
        '/head/output_conv2.2/'
    ],
    eval_num=10,
